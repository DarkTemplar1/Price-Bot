...
def main():
    ...
    parser.add_argument("--input", required=True, help="CSV z kolumną 'link'")
    parser.add_argument("--output", required=True, help="Plik wynikowy CSV")
    ...
    for i, url in enumerate(links, 1):
        ...
        if not data:
            print(f"[SCRAPER] ⚠️ Nie udało się pobrać: {url}")
            continue
